...
const HomePage = () => {
  const stats = [
    ...
    <div>
        ...
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center gap-6 mb-16" style={{ fontFamily: 'BalooBhai2' }}>
        {/* Left Image */}
      ...
      <section className="bg-gray-700 text-white py-12 px-4 my-3 font-bayon" style={{ fontFamily: 'BalooBhai2' }}>
