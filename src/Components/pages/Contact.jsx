...
export default function ContactSection() {
  ...
  {/* <div class="absolute inset-0 bg-gray-300">
    <iframe width="100%" height="100%" marginheight="0" marginwidth="0" title="map" scrolling="no" src="https://maps.google.com/maps?width=100%&amp;height=600&amp;hl=en&amp;q=%C4%B0zmir+(My%20Business%20Name)&amp;ie=UTF8&amp;t=&amp;z=14&amp;iwloc=B&amp;output=embed" style="filter: grayscale(1) contrast(1.2) opacity(0.4);"></iframe>
  </div> */}
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
          ...
          <div className="flex flex-col items-center">
            <div className="w-16 h-16 bg-blue-500 rounded-full flex items-center justify-center">
              <img src="/icons/building.svg" alt="Corporate Icon" className="w-8 h-8" />
            </div>
          ...
          <div className="flex flex-col items-center">
            <div className="w-16 h-16 bg-blue-500 rounded-full flex items-center justify-center">
              <img src="/icons/social.svg" alt="Social Icon" className="w-8 h-8" />
            </div>
